...
CREATE TABLE "new_AutomobileUsage" (
    ...
    CONSTRAINT "AutomobileUsage_driverId_fkey" FOREIGN KEY ("driverId") REFERENCES "Driver" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "AutomobileUsage_automobileId_fkey" FOREIGN KEY ("automobileId") REFERENCES "Automobile" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
